    ...
    public function run(): void
    {
        DB::table('music')->insert([
            ...
            [
                ...
                'song_cover_path' => 'songs_cover/Starboy.png',
                'file_path' => 'audios/raiya-chandiko-purna-bahadur-ko-sarangi-new-dohori-movie-song-ft-bijay-baral-anjana-baraili-128-ytshorts.savetube.me_1754416010.mp3',
                'artist_id' => 7, // Sushank Pandey (will be ID 7 in artists table)
                'album_id' => null,
                'genre' => 'Folk',
                'description' => 'Traditional Nepali folk song',
                'release_date' => '2024-01-15',
                'views' => 150,
                'uploaded_by' => 1, // For now, use existing user until User 9 is created via registration
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'album_id' => null,
                'genre' => 'Pop',
                'description' => 'Modern Nepali pop song',
