...
class ArtistDashboardController extends Controller
{
    ...
    public function getDashboardStats()
    {
        try {
            ...
            $totalRatings = $uploadedMusic->sum('ratings_count');
            $averageRating = $uploadedMusic->avg(function ($music) {
            ...
            for ($i = 5; $i >= 0; $i--) {
                ...
                $monthRatings = Rating::whereIn('rateable_id', $uploadedMusic->pluck('id'))
    ...
    public function getMyMusic(Request $request)
    {
        try {
            ...
            $music->getCollection()->transform(function ($song) {
                ...
                $song->average_rating = round($song->ratings_avg_rating ?? 0, 2);
